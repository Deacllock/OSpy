...
# Computes the sequence rate of every element in diff1 depending on packets received time.
        ...
        for i in range(len(diff2)):
            ...
            if i + 1 < len(diff2):
                ...
                if ip_increment > 1000:
                    if p_increment % 256 != 0 or (p_increment % 256 == 0 and ip_increment > 256000):
                        return 'RI'
