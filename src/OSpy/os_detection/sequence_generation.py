...
#  Total time shall be 500ms so that we can reliably detect the common 2Hz TCP timestamp sequences
...
def get_ops(responses):
    ...
    opt2char = {'EOL':'L', 'NOP':'N', 'MSS':'M', 'Timestamp':'T', 'SAckOK':'S', 'WScale':'W'}
...
def get_t1(responses):
    ...
    params['T'] = hex(r1[IP].ttl)[2:].upper() #check if you don't have to do weird stuff
